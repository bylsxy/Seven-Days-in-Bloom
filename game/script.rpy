...
label fc_ch2_student_council:
    $ new_node("fc_ch2_student_council")
...
label fc_ch2_astronomy:
    ...
    "我跑去图书馆，发现图书馆也关门了。"
    "我找不到图书管理员，只得先回家。"
label fc_ch3_dessert:
    $ new_node("fc_ch3_dessert")
    scene bg street with dissolve
    "路上经过了校门附近开的甜品店，看见里面开开心心的jk。"
    yt "（下次，可以的话，试着约会长出来吧。）"

label fc_ch2_evening:
    $ new_node("fc_ch2_evening")
    scene bg home with fade
    stop music
    n """
    ____________________________________________________________________________{fast}{nw}
...
label fc_ch3_cooking:
    ...
    "莫名想了个让我自己过意的去的解释。"
    scene bg astr lab with dissolve
    "正想着，我上楼走向了天文社活动室，完全忘记了上课铃的响起。"
    "(开门声————)"
    yt "『没人在吗？』"
    "空荡的教室里，天文望远镜和观测仪整齐摆放在一起。"
    "离门最近的桌子上放了张纸条，用录音带压住了。"
    n """
    ____________________________________________________________________________{fast}{nw}

    {space=400}{size=*2}【纸条】{/size}{nw}

    {space=60}我看你下午没来就写张纸条放桌上了，今天的天文社活动改到今天晚上八点，在学校的旧校舍里面的土堆上面。{nw}

    {space=60}活动内容是记录天文现象，顺便和摄影社的各位一起录制视频，佐佐木阳太你负责搬运需要的器材。
    ...
    "初一时听到学校地下室也只觉得是老鼠的声音。"
    "到初二才加入天文社，他们欢迎新人的仪式是鬼怪主题的吓人。"
    "这使得我直到初三都对着鬼怪故事深信不疑，经常出入于图书馆寻找偏方。"
    ...
    yt "『……嘿！』"
    yt "(累死了，终于搬完了。)"
    "本该是清爽的三月份,现如今我却因为搬东西跑上跑下跑的大汗淋漓。"
    yt "(对了，还要和她说一声。)"
    "不耐烦的想法油然而生。"
    scene bg astr lab with fade
    show ao none at top with dissolve:
        zoom 0.9
    ...
    define topright = Position(xalign=1.0, yalign=0.0)
    show ao none at topright
    with move
    ...
    show ao none at pos_right_jump
    yt "『不是！』"
    "我脱口而出，不料语气有些没有礼貌。"
    ...
    yt "『想着一个人去会显得有些可怜当时一时头热就邀请了藤原樱过来……』"
    yt "『果然还是太唐突了啊果咩捏』"
    yt "『没有啦，偶尔尝试一下也不是什么坏事，是吧，小早川葵同学』"
    "看着小早川葵同学迟迟没能加入，藤原樱好心地把她拉入了话题。"
    yt "(她现在还好吗?)"
    "我这么担心着，不过显然是我多虑了。"
...
label fc_ch3_conclusion:
    $ new_node("fc_ch3_conclusion")
    scene black with fade
    pause 1.0
    jump chapter_4
...
label chapter_4:
    ...
    n "____________________________________________________________________________{fast}{nw}"
    n "{space=60}『关于其他人的记忆会慢慢消散，就连人也会不见。』"
    n "{space=60}『如果全都记录在本子里，她们是不是就不会消失了？』{nw}"
    n "____________________________________________________________________________{fast}"
    nvl clear
    "——『不要用那本本子的能力来欺骗你在意的人。』"
    "蓝昨天说的话回响在脑海里。"
    "『如果可以的话我也不希望欺骗你们。』"
...
label fc_ch4_campus:
    ...
    "她说完便自顾自地离开了。"
    yt "（如果我能欺骗自己说“这么做是为了保护她们”，那我到底想保护谁？）"

label chapter_4_choice:
    $ new_node("chapter_4_choice")
    $ unlock_node("chapter_4_sakura_afternoon")
    $ unlock_node("ch4_aoi_branch")
    $ unlock_node("ch4_ao_branch")
    menu:
        "A.前往烹饪教室（藤原 樱）":
            jump chapter_4_sakura_afternoon
        "B.去田径场（小早川 葵）":
            n "____________________________________________________________________________{fast}{nw}"
