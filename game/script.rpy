...
label chapter_3:
    ...
    yt "『?什么叫'也’?』"
    ai "『这个班级活动完了就直接放学了，比平时要早半个小时。我们班刚好有个女生身体不好，我借着照顾她的名义就跑出来了。』"
    ...
    ai "『你怎么又和之前一样啊，你没来的时候还是我们几个跟学生会会长沟通的呢。』"
    yt "『会长过来说的?』"
    ai "『是啊，她比我们还急呢。』"
    ...
    ai "『没什么，这个桌子，和这个，这些。』"
    "她指着这些稀稀拉拉的设备对着我说。"
    ai "『你先把这些搬去一楼的空教室，钥匙我一把他们俩一把。走吧。』"
    yt "『这么多？』"
    ai "『我和他们俩下午已经把该搬的搬完了，快点。。。』"
    yt "『嘿！』"
    yt "(累死了，终于搬完了。)"
    ...
    ai "『藤原 樱同学好了解啊，不愧是烹饪教室的!』"
    skr "『什么?抱歉我刚刚没听清。』"
    aoi "『她说你很厉害呢，我也觉得。』"
    skr "『也没有啦。。』"
    "藤原 樱不好意思地低下了头，她们俩个已经想好了自己想点的东西。"
    ai "『藤原 樱同学会想试试这家店的樱花麻糬吗？』"
    skr "『嗯？』"
    "藤原 樱同学好像是又没听见，摆出了’没听见的表情‘。"
    ai "『啊，抱歉，藤原 樱同学还是点自己想吃的吧，我只是说说』"
